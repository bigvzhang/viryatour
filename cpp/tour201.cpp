...
#define TOUR_GROUP tour201_

#ifndef _MSC_VER//__cplusplus is not valid for MSVC
...
int main(int argc, char* argv[]) {
	...
	HORIZONTAL1();
    NOTICE(macros such as __cpp_attributes are not defined in cpp11 to cpp17)
	return 0;
}
